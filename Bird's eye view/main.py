# Prevent this file from being imported as a module
# This file is only meant to be run as a script
# When imported as a module, __name__ will be the module name, not "__main__"
if __name__ != "__main__":
    raise ImportError(
        "This file cannot be imported as a module. "
        "It is designed to be run as a script: python main.py"
    )
